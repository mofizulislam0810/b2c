...
if(settings.showDateTheme==='dd'){return'<span class="t-day-'+pr_class+'"> '+check_num_10(d.getDate())+'</span>'}else if(settings.showDateTheme==='dd/mm'||settings.showDateTheme==='dd-mm'){return'<span class="t-day-'+pr_class+'"> '+check_num_10(d.getDate())+'</span>'+'<span class="t-month-'+pr_class+'"> '+showMonths+' </span>'}else{return'<strong style="font-size:35px" class="t-day-'+pr_class+'"> '+check_num_10(d.getDate())+'</strong>'+'<span class="t-month-'+pr_class+'"> '+showMonths+' </span>'+'<span class="t-year-'+pr_class+'"> '+check_num_10(d.getFullYear())+'</span>'+'<strong class="t-day-'+pr_class+'"> '+weekday[d.getDay()]+'</strong>'}}else{return'';}}
