...
(function ($) {
  ...
  var Defaults = {
    ...
    numCalendar: 2,
    titleCheckIn: "Departing",
    titleCheckOut: "Returning",
    titleToday: "Today",
    titleDateRange: "day",
  ...
  $.fn.tDatePicker = function (pr_el, options) {
    ...
    function setThemeCheckDate(
      ...
      return (
        ...
        pr_class +
        '">' +
        "<span class='text-danger' style='font-size: 14px'><i class='fa fa-calendar'></i></span>" +
        '<label class="t-date-info-title pb-2" style="font-size: 14px;font-weight: 400">' +
        pr_title +
        "</label><br>" +
    ...
    function showThemeDate(pr_class, pr_data_utc) {
      if (pr_data_utc !== 0 && pr_data_utc !== null) {
        ...
        if (settings.showDateTheme === "dd") {
          ...
          return (
            '<strong style="font-size:30px" class="t-day-' +
            pr_class +
            '"> ' +
            check_num_10(d.getDate()) +
            "</strong>" +
            '<span style="font-size:18px" class="t-month-' +
            pr_class +
            '"> ' +
            showMonths +
            "'</span>" +
            '<span style="font-size:14px" class="t-year-' +
            pr_class +
            '">' +
            check_num_10(d.getFullYear().toString().substr(-2)) +
            "</span>" +
            '<span style="font-size:14px" class="t-day-' +
            pr_class +
            '"> ' +
            weekday[d.getDay()] +
            "</span>"
    ...
    function getDateUTC(pr_in, pr_out) {
      ...
      Array_In_Out.forEach(function (e) {
        ...
        var Input = "t-start";
        if (pr_in !== null) {
          label_title = settings.titleCheckIn;
        }
        if (e === "check-out") {
