...
const ShowModal = ({
  ...
  // const arrivalTime = direction0.segments[0].arrival.substr(11,5);
  // const depatureTime = direction0.segments[1].departure.substr(11,5);
  // console.log(depatureTime-arrivalTime);
  //console.log(origin,destination);
  // const {platingCarrier} = direction0;
  // console.log('direction0 Modal')
  //  console.log(direction0)
  //     console.log('direction1 Modal')
  //  console.log(direction1)
  //  console.log(Object.keys(direction1).length)
  ...
  //   localStorage.setItem('bookingComponents',JSON.stringify(bookingComponents));
  // }

  useEffect(() => {
    // $(document).ready(function () {
    //   $("#flightId" + index).attr("style", "background:#164cf3");
    //   $("#baggageId" + index).attr("style", "background:#00014a");
    //   $("#changeId" + index).attr("style", "background:#00014a");
    //   $("#fareId" + index).attr("style", "background:#00014a");
    // });
    ...
    //   $("#flightId" + index).attr("style", "background:#00014a");
    //   $("#baggageId" + index).attr("style", "background:#164cf3");
    //   $("#changeId" + index).attr("style", "background:#00014a");
    //   $("#fareId" + index).attr("style", "background:#00014a");
    // });
    ...
    //   $("#flightId" + index).attr("style", "background:#00014a");
    //   $("#baggageId" + index).attr("style", "background:#00014a");
    //   $("#changeId" + index).attr("style", "background:#164cf3");
    //   $("#fareId" + index).attr("style", "background:#00014a");
    // });
    ...
    //   $("#baggageId" + index).attr("style", "background:#00014a");
    //   $("#changeId" + index).attr("style", "background:#00014a");
    //   $("#fareId" + index).attr("style", "background:#164cf3");
    // });
                  ...
                  <div className="container p-2 pb-5">
                    ...
                    <div className="table-responsive-sm mt-1">
                      <table
                        ...
                        style={{ fontSize: "12px" }}
                      >
                        <thead className="text-center thead text-dark fw-bold">
                          <tr>
                            <th>Type</th>
                            <th>Base</th>
                            <th>Tax</th>
